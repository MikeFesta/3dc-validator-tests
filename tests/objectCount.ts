...
describe('object count passing report', function () {
  ...
  describe('no object count checks', function () {
    before('load schema', async function () {
      try {
        await v.schema.loadFromFileSystem('schemas/object-count/object-count-no-check.json');
      } catch (err) {
  ...
  describe('max mesh count', function () {
    before('load schema', async function () {
      try {
        await v.schema.loadFromFileSystem('schemas/object-count/object-count-pass.json');
      } catch (err) {
...
describe('object count failing report', function () {
  ...
  before('load model and schema', async function () {
    ...
    try {
      await v.schema.loadFromFileSystem('schemas/object-count/object-count-fail.json');
    } catch (err) {
